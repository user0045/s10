...
const EditContentDialog: React.FC<EditContentDialogProps> = ({
  ...
  if (loadingContent) {
    return (
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="bg-card/90 backdrop-blur-sm border border-border/50 max-w-6xl max-h-[90vh] overflow-y-auto relative z-[60]">
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="bg-card/90 backdrop-blur-sm border border-border/50 max-w-6xl max-h-[85vh] overflow-y-auto relative z-[60] top-[5%] translate-y-0">
